...
def user_login_valid_creds_and_token() -> Generator[dict[str, str], Any, None]:
...
@pytest.fixture(scope="function")
def user_login_valid_creds(user_login_valid_creds_and_token) -> dict[str, str]:
    return user_login_valid_creds_and_token['auth_data']


@pytest.fixture(scope="function")
def logged_user_access_token(user_login_valid_creds_and_token) -> str:
    return user_login_valid_creds_and_token['access_token']


second_login_valid_creds_and_token = user_login_valid_creds_and_token


@pytest.fixture(scope="function")
def second_logged_user_access_token(second_login_valid_creds_and_token) -> str:
    return second_login_valid_creds_and_token['access_token']
